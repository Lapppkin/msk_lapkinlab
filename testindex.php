...
$APPLICATION->SetPageProperty("keywords", "продвижение сайта, seo москва");
$APPLICATION->SetPageProperty("description", "Раскрутка и продвижение сайтов в Москве и РФ от агентства LapkinLab &#9997;SEO оптимизация, контекстная реклама, продвижение в соц.сетях (SMM) &#9997;Разработка сайтов");
$APPLICATION->SetPageProperty("title", "Продвижение сайтов в Москве - SEO (СЕО) раскрутка сайта в ТОП 10 Яндекс и Google (Гугл)");
...
?>
    <main role="main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 left_banner">
                        <div class="text">
                            Тысячи покупателей уже ищут то, что вы предлагаете. <br>
                            А с SEO найдут именно вас!
                        </div>
                        <ul class="main_ul">
                            <li>Оптимизируем сайт для поисковых машин</li>
                            <li>Делаем его удобным для клиентов</li>
                            <li>Приводим целевых пользователей из поисковых систем</li>
                            <li>Продажи растут уже в первые месяцы после начала работ</li>
                            <li>Оставляем ваших конкурентов позади</li>
                        </ul>
                    </div>
                    <div class="col-md-4">
        ...
        <section class="banner noactive_ban" id="ban2">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 left_banner">
                        <div class="text">
                            Подходим комплексно к оптимизации вашего сайта:<br>
                        </div>
                        <ul class="main_ul">
                            <li>Выявим вашу аудиторию</li>
                            <li>Соберем целевые запросы покупателей</li>
                            <li>Проведем конкурентный анализ</li>
                            <li>Выполним аудит сайта, выявим и устраним слабые места</li>
                            <li>Оптимизируем структуру и выполним все технические работы по проекту</li>
                            <li>Доведем до результата — поднимем трафик, вырастим позиции!</li>
                        </ul>
                    </div>
                    <div class="col-md-4">
                        <form class="form_banner" action="/mail_post.php" method="post">
        ...
        <section class="banner noactive_ban" id="ban3">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 left_banner">
                        <div class="text">
                        ...
                        <ul class="main_ul">
                            <li>«Дедлайн» - для нас не просто слово</li>
                            <li>Постоянная связь с клиентом на всех этапах продвижения</li>
                            <li>Наш менеджер всегда готов ответить на любые вопросы по вашему сайту</li>
                            <li>Регулярная отчетность - мы знаем как важно видеть наглядный результат!</li>
                        </ul>
                    </div>
                    <div class="col-md-4">
                        <form class="form_banner" action="/mail_post.php" method="post">
        ...
        <section class="banner noactive_ban" id="ban4">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 left_banner">
                        <div class="text">
                            Результаты и гарантии<br>
                            Мы гарантируем:
                        </div>
                        <ul class="main_ul">
                            <li>Рост позиций сайта после 1 месяца</li>
                            <li>Увеличение посещаемости ресурса после 2 месяца</li>
                            <li>Уже через 4 месяца вы заметите рост продаж</li>
                            <li>Стабильный рост видимости и позиций сайта</li>
                            <li>Прозрачная отчетность</li>
                            <li>Конфиденциальность клиентской информации</li>
                            <li>«Белые» методы продвижения</li>
                        </ul>
                    </div>
                    <div class="col-md-4">
                        <form class="form_banner" action="/mail_post.php" method="post">
                            ...
                            <input type="text" name="your-phone" placeholder="Телефон" value="" required="">
                            <input type="text" name="your-email" placeholder="Почта" value="" required="">
                            <p style="display:none;"><input type="text" name="name"></p>
                            <button type="submit" name="button" value="Проверить сайт" onclick="ym(45994323, 'reachGoal', 'push'); return true;">Проверить сайт</button>
                            Нажимая на кнопку Проверить сайт, я даю согласие на обработку персональных данных
                        </form>
                    </div>
        ...
        <div class="container button_banner">
            <div class="row">
                <div class="col-md-12">
                    <div class="row1">
                        <div class="col-xs-6 col-sm-6 col-md-3">
                            <div class="butt_p">
                                <div class="butt active" id="ban1">
                                    <i class="icon icon-fire"></i>
                                    Увеличение<br> продаж
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-3">
                            <div class="butt_p">
                                <div class="butt" id="ban2">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-3">
                            <div class="butt_p">
                                <div class="butt" id="ban3">
                                    <i class="icon icon-star"></i>
                                    Клиентский<br> сервис
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-3">
                            <div class="butt_p">
                                <div class="butt" id="ban4">
                                    <i class="icon icon-star"></i>
                                    Результаты<br> и гарантии
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="one">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="title">Сделаем так, чтобы ваш бизнес находили</p>
                    </div>

                    <div class="col-sm-12 col-md-12 textblomid" style=" padding-top:40px;">

                        <div class="col-sm-6 col-md-4">
                            <div class="blt">
                                <div class="leftrrr">
                                    <p class="color">Усилим и закрепим<br> позиции в выдаче</p>
                                    <p class="grey">Бесплатно продвинем<br> низкочастотные фразы</p>
                                </div>
                                <div class="icob1"></div>
                            </div>

                            <div class="blt" style="padding-right: 40px; padding-top:20px;">
                                <div class="leftrrr">
                                    <p class="color">Проведем seo<br> аудит сайта</p>
                                    <p class="grey">Выявление пробелов<br>в оптимизации</p>
                                </div>
                                <div class="icob2"></div>
                            </div>

                            <div class="blt" style="padding-top:20px;">
                                <div class="leftrrr">
                                    <p class="color">Семантическое ядро<br> (составление)</p>
                                    <p class="grey">Проведение работ по<br> подбору ключевых фраз</p>
                                </div>
                                <div class="icob3"></div>
                            </div>
                        </div>
                        ...
                        <div class="hidden-sm hidden-xs col-md-4 midlblo flex_center" style=" padding-top:60px;">
                            <img src="/bitrix/templates/new_design/assests/centr.png">
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="brt">
                                <div class="icob4"></div>
                                <div class="rightrrr">
                                    <p class="color">Увеличим посещаемость<br> и продажи</p>
                                    <p class="grey">Приведем целевых<br> посетителей уже на 3-ий месяц</p>
                                </div>
                            </div>

                            <div class="brt" style="padding-left: 40px; padding-top:20px;">
                                <div class="icob5"></div>
                                <div class="rightrrr">
                                    <p class="color">Анализ<br> конкурентов</p>
                                    <p class="grey">Изучение тематики,<br> методов продвижения конкурентов</p>
                                </div>
                            </div>

                            <div class="brt" style="padding-top:20px;">
                                <div class="icob6"></div>
                                <div class="rightrrr">
                                    <p class="color">Настроим систему<br> аналитики</p>
                                    <p class="grey">Настроим сервисы <br>статистики Яндекс и Google</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="thre">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="title">Рост трафика и продаж с 3-его месяца</p>
                    </div>
                    <div class="col-md-12 rosttt">
                        <p>Увеличение продаж — это результат работ по комплексному SEO-продвижению Вашего сайта в поисковых системах.</p>
                    </div>

                    <div class="col-sm-12 col-md-3 lef">
                        <p>Условные обозначения:</p>
                        <div class="fffdf">
                            <p class="fffdf1">Посетители</p>
                            <p class="fffdf2">Заявки</p>
                        </div>
                    </div>
        ...
        <section class="five">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="title">Используем комплексный подход</p>
                    </div>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="bbcd activeb" id="bbc" data-id="1">
                                    <p class="tt">Анализ конкурентов</p>
                                    <p>Изучение тематики, анализ конкурентов и методов их продвижения</p>
                                </div>
                                <div class="bbcd" id="bbc" data-id="2">
                                    <p class="tt">Разработка стратегии</p>
                                    <p>Создание эффективной SEO-стратегии, ведущей к достижению ТОПа</p>
                                </div>
                                <div class="bbcd" id="bbc" data-id="3">
                                    <p class="tt">Оптимизация сайта</p>
                                    <p>Проведение работ по внутренней и внешней оптимизации сайта</p>
                                </div>
                                <div class="bbcd" id="bbc" data-id="4">
                                    <p class="tt">Прозрачная отчетность</p>
                                    <p>Отчетность о результатах проведения работ и обо всех рабочих процессах по проекту</p>
                                </div>
                            </div>
                            <div class="col-md-8 dfjkdf">
                                <div id="ibbc1" class="activebi" style="background: url('/bitrix/templates/new_design/assests/i1.png');">
                                    <div class="over">
                                        <p class="tt">Анализ конкурентов</p>
                                        <p>Осуществляем детальный анализ отрасли: изучаем конкурентов на предмет внутренней и внешней оптимизации, выявляем математические модели
                                            ранжирования, рассчитываем корреляцию между факторами ранжирования и их влиянием на занимаемые сайтом позиции.</p>
                                    </div>
                                </div>

                                <div id="ibbc2" class="activebin" style="background: url('/bitrix/templates/new_design/assests/013/im2.jpg');">
                                    <div class="over">
                                        <p class="tt">Разработка стратегии</p>
                                        <p>Успех не бывает спонтанным. Четкий план и конкретные цели позволяют нам определить самые эффективные средства для достижения желаемого
                                            результата - увеличения оборота вашего бизнеса.</p>
                                    </div>
                                </div>

                                <div id="ibbc3" class="activebin" style="background: url('/bitrix/templates/new_design/assests/013/im3.jpg');">
                                    <div class="over">
                                        <p class="tt">Оптимизация сайта</p>
                                        <p>Проведя глубокий, всесторонний аудит сайта, мы приступаем к работам по внутренней и внешней оптимизации ресурса, постепенно превращая ваш
                                            сайт в лидера ниши.</p>
                                    </div>
                                </div>

                                <div id="ibbc4" class="activebin" style="background: url('/bitrix/templates/new_design/assests/013/im4.jpg');">
                                    <div class="over">
                                        <p class="tt">Прозрачная отчетность</p>
                                        <p>Наглядный и понятный отчет по продвижению сайта? Да, мы это умеем. Каждые 2 недели специалисты предоставляют полный отчет о работах,
                                            которые
                                            были проведены, и о результатах, которые были достигнуты. Теперь метрики сайта, динамика позиций и изменения трафика вы сможете увидеть
                                            не
                                            только в специальных сервисах, но и прямо в pdf-файле с отчетностью.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 tabk active_ta" id="ff2">
                                <ul class="nummmm">
                                    <li>Продолжение работ по контентной оптимизации сайта. Подготовка очередной партии текстов. Их согласование с заказчиком и внесение на сайт.
                                    </li>
                        ...
                        <div class="row">
                            <div class="col-md-12 Ktabk Kactive_ta" id="Kff1">
                                ...
                                <div class="col-md-8 cccd" style="padding:0px; margin:0px;">
                                    ...
                                    Цели достигнуты в полном объеме. Сайт постоянно обновляется. За счет контекстной рекламы достигнута посещаемость 20 000 уникальных посетителей в
                                    месяц. Более 85% фраз в ТОП10.
                                </div>
                                <div style="width: 100%; height: 20px; clear: both"></div>
                                <div class="col-md-8 imgkeq">
                                    <img src="/bitrix/templates/new_design/assests/shatura4.png">
                                </div>
                                <div class="col-md-4 imgkeq">
                                    <img src="/bitrix/templates/new_design/assests/shatura5.png">
                                </div>

                                <div style="width: 100%; height: 20px; clear: both"></div>
                                <p class="cccd">Продвижение в поисковых системах Яндекс и Google</p>

                                <div class="col-md-6 navlef navar" data-id="3"><img src="/bitrix/templates/new_design/assests/left.png">Предыдущий кейс</div>
                                <div class="col-md-6 navrig navar" data-id="2"> Следующий кейс<img src="/bitrix/templates/new_design/assests/right.png"></div>
                            ...
                            <div class="col-md-12 Ktabk Kactive_tan" id="Kff2">
                                ...
                                <div class="col-md-8 cccd" style="padding:0px; margin:0px;">
                                    <p class="ccc">Результат</p>
                                    98% фраз находятся в ТОП-10, в среднем 6-7 тыс. уникальных посетителей в месяц, 215 заявок через форму обратной связи, около 700 обращений по
                                    телефону
                                </div>
                                <div style="width: 100%; height: 20px; clear: both"></div>
                                <div class="col-md-8 imgkeq">
                                    <img src="/bitrix/templates/new_design/assests/013/m1.jpg" style="height: 280px;">
                                </div>
                                <div class="col-md-4 imgkeq">
                                    <img src="/bitrix/templates/new_design/assests/013/m2.jpg">
                                </div>

                                <div style="width: 100%; height: 20px; clear: both"></div>
                                <p class="cccd">Продвижение в поисковых системах Яндекс и Google</p>

                                <div class="col-md-6 navlef navar" data-id="1"><img src="/bitrix/templates/new_design/assests/left.png">Предыдущий кейс</div>
                                <div class="col-md-6 navrig navar" data-id="3"> Следующий кейс<img src="/bitrix/templates/new_design/assests/right.png"></div>
                            ...
                            <div class="col-md-12 Ktabk Kactive_tan" id="Kff3">
                                ...
                                <div style="width: 100%; height: 20px; clear: both"></div>
                                <div class="col-md-8 imgkeq">
                                    <img src="/bitrix/templates/new_design/assests/013/t1.jpg" style="height: 280px;">
                                </div>
                                <div class="col-md-4 imgkeq">
                                    <img src="/bitrix/templates/new_design/assests/013/t2.jpg">
                                </div>

                                <div style="width: 100%; height: 20px; clear: both"></div>
                                <p class="cccd">Продвижение в поисковых системах Яндекс и Google</p>

                                <div class="col-md-6 navlef navar" data-id="2"><img src="/bitrix/templates/new_design/assests/left.png">Предыдущий кейс</div>
                                <div class="col-md-6 navrig navar" data-id="1"> Следующий кейс<img src="/bitrix/templates/new_design/assests/right.png"></div>
        ...
        <section class="eight">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12 col-md-3 Ptabs" data-id="1">
                                Продвижение<br>сайтов услуг
                            </div>
                            <div class="col-sm-12 col-xs-12 col-md-3 Ptabs Pactive_t" data-id="2">
                                Продвижение<br>интернет-магазинов
                            </div>
                            <div class="col-sm-12 col-xs-12 col-md-3 Ptabs" data-id="3">
                                Продвижение<br>порталов
                            </div>
                            <div class="col-sm-12 col-xs-12 col-md-3 Ptabs" data-id="4">
        ...
        <section class="price">
            <div class="container">
                <div class="left-block">
                    ...
                    <ul>
                        <li>Достигаем целевых позиций в «Яндекс» и Google по ключевым словам</li>
                    ...
                    <div id="main-composition">
                        ...
                        <ul class="ul-main-composition">
                            ...
                            <li class="not-exist">Проведение юзабилити аудита</li>
        ...
        <section class="nine">
            <div class="container">
                <div class="row milo">
                    <div class="col-md-12">
                        <p class="title">Мы любим свое дело</p>
                    </div>

                    <div class="col-md-6">
                        <p class="ttt">Фиксированные цены</p>
                        <p class="pp">Все цены указаны на сайте – не надо ждать обсчета. Цена не меняется от конкуренции, количества ключевых слов и т.п. Кроме того, в каждый пакет
                            уже
                            заложена скидка до 56% – потому что «оптом дешевле».</p>
                    </div>
                    <div class="col-sm-12 col-xs-12 col-md-6">
                        <img src="/bitrix/templates/new_design/assests/bitrix.png" style="float: left;">
                        <img src="/bitrix/templates/new_design/assests/top.png" style="float: right;">
                    </div>

                    <div class="col-md-6">
                        <p class="ttt">Без мук выбора</p>
                        <p class="pp">Вам не придется выбирать «продвижение по трафику, позициям или за лид». Работаем по западной модели ценообразования – оплата за конкретные
                            работы.
                            Результаты получаются одинаковые, а бешеные накрутки за гарантию отсутствуют.</p>
                    </div>
                    <div class="col-md-6 vvv">
                        <p>Познакомимся?</p> <a class="tm_pb_button" href="#win1" onclick="ym(45994323, 'reachGoal', 'brif'); return true;">Заполнить бриф</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="ten">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="title">Подарки и скидки для наших клиентов</p>
                    </div>

                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-12 col-md-4 block_twof">
                                <img src="/bitrix/templates/new_design/assests/test.png">
                            ...
                            <div class="col-sm-12 col-md-4 block_twof">
                                <img src="/bitrix/templates/new_design/assests/high-five.png">
                            ...
                            <div class="col-sm-12 col-md-4 block_twof">
                                <img src="/bitrix/templates/new_design/assests/stopwatch.png">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <!--
                                                    <div class="col-sm-12 col-md-4 block_news">
                                                    <a href="/novosti/mobilnaya-versiya-sayta-chek-list-dlya-audita.html">
                                                        <div class="img" style="background: url('/upload/iblock/588/Marketing_Automation_Checklist-min-1354x645.jpg'); background-size: cover; background-repeat: no-repeat;">
                                                        </div>
                                                    </a>
                                                        <div class="tit"><a href="/novosti/mobilnaya-versiya-sayta-chek-list-dlya-audita.html"> Мобильная версия сайта: чек-лист для аудита </a></div>
                                                        <div class="bottit">  </div>
                                                        <div class="botfff">
                                                            <p style="float: left;">28 ноября 2018</p>
                                                            <p style="float: right;">Статьи</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-4 block_news">
                                                    <a href="/novosti/yandeks-obnovil-algoritm-podbora-rekomendovannykh-zaprosov.html">
                                                        <div class="img" style="background: url('/upload/iblock/01c/%25D0%259D%25D0%25B0%25D1%2581%25D1%2582%25D1%2580%25D0%25BE%25D0%25B8%25CC%2586%25D0%25BA%25D0%25B0-%25D0%25AF%25D0%25BD%25D0%25B4%25D0%25B5%25D0%25BA%25D1%2581.%25D0%2592%25D0%25B5%25D0%25B1%25D0%25BC%25D0%25B0%25D1%2581%25D1%2582%25D0%25B5%25D1%2580-1230x645.jpg'); background-size: cover; background-repeat: no-repeat;">
                                                        </div>
                                                    </a>
                                                        <div class="tit"><a href="/novosti/yandeks-obnovil-algoritm-podbora-rekomendovannykh-zaprosov.html"> Яндекс обновил алгоритм подбора рекомендованных запросов </a></div>
                                                        <div class="bottit">  </div>
                                                        <div class="botfff">
                                                            <p style="float: left;">21 ноября 2018</p>
                                                            <p style="float: right;">Статьи</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-4 block_news">
                                                    <a href="">
                                                        <div class="img" style="background: url('/upload/iblock/37e/current-affairs-3-min-1354x645.jpg'); background-size: cover; background-repeat: no-repeat;">
                                                        </div>
                                                    </a>
                                                        <div class="tit"><a href="/novosti/v-poiskakh-poteryannogo-trafika-istoriya-prodvizheniya-kataloga-tovarov.html"> В поисках потерянного трафика: история продвижения каталога товаров </a></div>

                                                        <div class="bottit">  </div>
                                                        <div class="botfff">
                                                            <p style="float: left;">02 ноября 2018</p>
                                                            <p style="float: right;">Статьи</p>
                                                        </div>
                                                    </div>
                            -->
                            <div class="col-md-12 botnew">
                                <a class="tm_pb_button" href="/novosti/">Смотреть все статьи</a>
                            </div>
                        ...
                        <form action="/mail_post.php" method="post">
                            ...
                            <div class="col-md-12" style="text-align: center;">
                                <input type="submit"
                                       ...
                                       onclick="ym(45994323, 'reachGoal', 'otpravka'); return true;">
                            </div>
        ...
        <section class="tenfour">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="title">SEO-продвижение сайтов в Москве</h1>
                    </div>
                    <div class="col-md-12 fpfppf">

                        <p class="ffffe">Самый нужный и интересный сайт может остаться незамеченным, если его не продвигать. Для привлечения целевой аудитории из поисковых систем
                            заказывают СЕО продвижение. Комплекс работ по оптимизации нацелен на выведение сайта в ТОП 10 Яндекс, Google по выбранным запросам.<br><br>
                            Чем выше веб-ресурс в поисковой выдаче, тем больше посетителей из сети Интернет приходит. Формируется положительный имидж компании, повышается
                            лояльность
                            клиентов. Можно не прибегать к оффлайн-рекламе, достаточно СЕО оптимизации, цены на которую ниже выпуска печатных рекламных носителей.
                        </p>

                        <h2>Когда СЕО услуги выгоднее других методов продвижения?</h2>
                        <p class="ffffe">Для увеличения трафика на сайт можно заказать СЕО продвижение или применить контекстную рекламу. Каждый подход имеет свои преимущества, но,
                            если вы рассчитываете на долгосрочный устойчивый эффект, выбирайте оптимизацию.<br><br>
                            <b>Преимущества SEO продвижения</b><br>
                            • Новый посетитель по выгодной цене — стоимость до 4 раз меньше по сравнению контекстной рекламой. <br>
                            • Прозрачность ценообразования — цена продвижения сайта фиксируется в договоре, в случае с контекстной рекламой конечная стоимость зависит от
                            конкуренции
                            объявлений.<br>
                            • Широкий охват аудитории — посетители приходят на сайт по продвигаемым ключевым фразам и всем словам, включенным в семантическое ядро.<br><br>
                            Если вы рассчитываете плавно увеличивать конверсию и наращивать прибыль, оказаться в ТОП выдачи, стоит заказать продвижение сайта в ТОП. <br>
                            Лучшие результаты показывает комплексный подход — сочетание поисковой оптимизации и контекстной рекламы. <br>
                            <br></p>

                        <h2>Цена SEO-продвижения сайта в Москве</h2>
                        <p class="ffffe">Цена СЕО продвижения сайта включает оплату специальных сервисов, создания ссылочной массы, работу специалистов - seo-оптимизатора,
                            программиста, копирайтера. <br><br>
                            Точную стоимость мы озвучиваем после аудита ресурса и выбора стратегии. Чтобы рассчитать конечную цену, мы должны знать, какой результат вы ожидаете и в
                            какие сроки хотите получить.<br><br>
                            Цена продвижения сайта в ТОП зависит от:<br>
                            • структуры и объема ресурса,<br>
                            • сложности подготовительных работ,<br>
                            • конкуренции в тематике, <br>
                            • поставленных целей;<br>
                            • региона продвижения.<br>
                            <br></p>

                        <h2>5 причин заказать SEO оптимизацию в LapkinLab</h2>
                        <p class="ffffe">
                            • Комплексный подход — мы применяем различные маркетинговые инструменты, внимательно изучаем особенности веб-ресурса и выполняем комплекс необходимых
                            мер.<br>
                            • Безопасность — применение белых методов оптимизации исключает риск бана от поисковых систем, сайт развивается естественно и стабильно.<br>
                            • Эффективные стратегии продвижения — мы используем собственные наработки в различных тематиках, учитываем малейшие изменения в алгоритмах работы
                            поисковиков. <br>
                            • Честные цены продвижения сайта в ТОП — доступная стоимость без скрытых платежей. Вы платите за услуги, которые нужны именно вашему сайту. <br>
                            • Сопровождение специалиста — каждый проект ведет менеджер: от согласования целей раскрутки до получения ожидаемого результата.<br><br>
                            Позвоните нам, чтобы обсудить ваши идеи и наши предложения.
                            <br></p>
                    </div>
                </div>
            </div>
