        ...
        <div class="container">
            <div class="row milo">
                ...
                <div class="col-sm-12 col-xs-12 col-md-6">
                    <img alt="сертифицированный партнёр битрикса" src="/local/templates/new_design/assests/bitrix.png" style="float: left;">
                    <img "входим в ТОП 40 сео студий" src="/local/templates/new_design/assests/top.png" style="float: right;">
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 fpfppf">
                    ...
                    <p class="ffffe">Любой сайт с интересным контентом может оказаться невостребованным ввиду отсутствия поискового продвижения. Эта процедура предусматривает привлечение целевой аудитории из поисковиков посредством оптимизации сайта. <br><br>
                        Чем выше позиции сайта в поисковой выдаче, тем на большее количество интернет-посетителей может рассчитывать его владелец. За счет этого формируется репутация бренда и лояльность клиентов. Сегодня оптимизации сайта вполне достаточно для того, что привлечь требуемое количество клиентов, не прибегая к рекламным оффлайн-кампаниям.
                    </p>

                    <h2>Преимущества SEO-продвижения</h2>
                    <p class="ffffe">СЕО-раскрутка позволяет существенно увеличить трафик сайта на долгосрочной основе. Среди других преимуществ SEO-продвижения стоит отметить:<br><br>
        
                        •	Возможность привлечения новых посетителей по цене, которая в 4 раза меньше стоимости контекстной рекламы. <br>
                        •	Прозрачность ценообразования. Стоимость продвижения четко фиксируется в клиентском соглашении. А вот стоимость контекстной рекламы зависит от конкурентной среды.<br>
                        •	Широкий обхват аудитории. Пользователи находят интересующую информацию на сайте благодаря ключевым словам, составляющим семантическое ядро.<br><br>
                        СЕО раскрутка сайта способна обеспечить плавное увеличение конверсии и наращивание прибыли благодаря попаданию в топ поисковой выдачи. А необходимый результат гарантирует комплексный подход, предусматривающий использование контекстной рекламы и поисковой оптимизации. <br>
                    </p>




                    <h2>Цена СЕО-продвижения в Москве</h2>
                    <p class="ffffe">В стоимость продвижения входит формирование ссылочной массы, а также оплата работы специальных сервисов, программистов, СЕО-оптимизаторов и копирайтеров.<br><br>
                        Окончательная стоимость определяется на основании выполненного аудита сайта и выбранной стратегии. Для расчета конечной цены, нам нужно знать какой именно результат вас интересует и в какие сроки вы планируете его получить. <br><br>
                        На стоимость раскрутки влияет:<br>
                        •	структура ресурса;<br>
                        •	сложности, возникающие в процессе подготовки;<br>
                        •	конкурентная среда;<br>
                        •	цели заказчика;<br>
                        •	регион продвижения.<br>
                        <br></p>

                    <h2>Почему оптимизацию стоит заказать в LapkinLab</h2>
                    <p class="ffffe">
                        •	Комплексный подход. Наши специалисты используют все возможные инструменты, которые позволят продвинуть в топ конкретный ресурс.<br>
                        •	Безопасность. Мы используем исключительно санкционированные способы оптимизации. Наши клиенты могут не переживать о возможном бане от поисковиков.<br>
                        •	Эффективность. Мы применяем эффективные стратегии, которые уже давали необходимый результат в конкретной тематике.<br>
                        •	Доступность. Мы гарантируем прозрачное ценообразование без скрытых платежей. Вы платите только за те услуги, которые реально помогут вашему сайту попасть в топ.<br>
                        •	Профессиональная поддержка. Все клиенты нашей компании могут рассчитывать на постоянную поддержку специалистов: с этапа согласования целей и до оценки полученного результата.<br><br>
                       Если вам интересны наши предложения, звоните нам прямо сейчас. Мы всегда открыты к сотрудничеству!
                        <br></p>
                </div>
            </div>
        </div>
