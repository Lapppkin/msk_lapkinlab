...
<section class="page page-privacy">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <p>Данная политика конфиденциальности относится к сайту с доменным именем <a href="https://msk.lapkinlab.ru">msk.lapkinlab.ru</a> и его поддоменам. Страница содержит сведения о том, какую информацию администрация сайта или третьи лица могут получать, когда пользователь (вы) посещаете его.</p>
                ...
                <ul class="ul-dot-empty">
                    <li>По телефону: <?= \LapkinLab\Helper::parsePhone(SITE_CONFIG['phone']) ?></li>
                    <li>С помощью формы: <a href="#" class="js-open-modal" data-action="openModal" data-modal="callback">онлайн-заказа</a></li>
                    <li>По электронной почте: <?= \LapkinLab\Helper::renderEmail(SITE_CONFIG['email_other']) ?></li>
                </ul>
            </div>
        </div>
    </div>
