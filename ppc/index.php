        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1 col-md-6 offset-md-0 col-sm-12 offset-sm-0">
                    ...
                    <p>Настроим и возьмем на себя ведение <a href="/ppc/yandex-direct/">рекламной кампании в поисковой системе Яндекс</a>, соберем широкое (без ограничения по количеству ключей) семантическое ядро, составим продающие тексты объявлений, подключим и будем отслеживать эффективность вашей рекламы, дадим рекомендации по доработке сайта для увеличения конверсии.</p>
                    <p>
                        <a href="/ppc/yandex-direct/">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/images/yandex-direct.png" alt="yandex-direct">
                        </a>
                    </p>
                </div>
                <div class="col-lg-5 col-md-6">
                    ...
                    <p>
                        <img src="<?= SITE_TEMPLATE_PATH ?>/images/google-adwords.png" alt="google-adwords">
                    </p>
                </div>
            </div>
        </div>
