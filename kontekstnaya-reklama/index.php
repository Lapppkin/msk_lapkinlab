...
<style>
	#but_calc{
		text-decoration:none; font-weight:bold; text-align: center;position: fixed;right: 30px;bottom: 190px;background: #fa3a5e; color:#fff; border-radius:15px; padding:10px; z-index:9990;
	}
	#but_calc span{
		display:none;
...
<main role="main"> <section class="banner active_ban" id="ban1">
<div class="container">
	<div class="row">
 ...
 <input type="text" name="your-site" placeholder="Сайт" value="" required=""> <input type="text" name="your-phone" placeholder="Телефон" value="" required=""> <input type="text" name="your-email" placeholder="Почта" value="" required="">
				<p style="display:none;">
 <input type="text" name="name" value="">
				</p>
 <button type="submit" name="button" value="Подобрать стратегию" onclick="ym(45994323, 'reachGoal', 'strategy'); return true;">Подобрать стратегию</button>
				Нажимая на кнопку Подобрать стратегию, я даю согласие на обработку персональных данных
			</form>
		</div>
	</div>
</div>
 </section> <section class="one sus">
<div class="container">
	<div class="row">
		<div class="col-md-12">
 ...
 <img src="../../assests/2-layersg.png">
		...
		<div class="col-sm-12 col-md-6">
			...
			<p class="h4">
				 Настраиваем контекстную рекламу в Google под ключ, проверяем или проводим подключение сервисов аналитики, подбираем наиболее релевантные ключевые слова. Рекламное объявление увидит именно ваша аудитория в выбранном регионе.
			</p>
		</div>
	</div>
</div>
 </section> <section class="two sro">
<div class="container">
	<div class="row">
		<div class="col-md-12">
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-12 col-md-4 blo">
			...
			<div class="tet">
				 Этот рекламный продукт ориентируется на зрительное восприятие покупателей, привлекает внимание аудитории с помощью ярких изображений, видео-контента, аудио.
			</div>
		</div>
		<div class="col-sm-12 col-md-4 blo">
			<div class="tit">
		...
		<div class="col-sm-12 col-md-4 blo">
			...
			<div class="tet">
				 Видеоролик, который запомнится аудитории и вызовет желание приобрести товар/услугу, показанный на партнерских сайтах поисковых систем - отличный способ охватить целевых клиентов
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-12 eeee">
			...
			<div class="col-sm-12 col-md-5 fdff">
				...
				<div class="tit221L">
					 Осуществляем подбор подходящих инструментов контекстной рекламы, настраиваем системы аналитики, создаем цели в ЯндексМетрике и GoogleAnalitics, устанавливаем системы колл-трекинга.
				</div>
			</div>
		</div>
		<div class="col-md-12 eeee">
			<div class="col-sm-12 col-md-6 fdff">
				...
				<div class="tit221">
					 Формируем семантику (ключевые запросы, по которым вас ищут клиенты), делаем минусовку нецелевых запросов, создаем объявления под каждое ключевое слово и согласовываем кампанию в вами.
				</div>
			</div>
			<div class="col-sm-12 col-md-1 fdff">
				<div class="dfdffffff">
		...
		<div class="col-md-12 eeee">
			<div class="col-sm-12 col-md-6 fdff">
				...
				<div class="tit221">
					 Настраиваем параметры рекламной кампании, создаем виртуальные визитки, быстрые ссылки, корректируем ставки и отправляем кампанию на проверку модераторам поисковых систем
				</div>
			</div>
			<div class="col-sm-12 col-md-1 fdff">
				<div class="dfdffffff">
		...
		<div class="col-md-12 eeee">
			...
			<div class="col-sm-12 col-md-5 fdff">
				...
				<div class="tit221L">
					 Каждый месяц отчитываемся о результатах кампании, расходе и распределении бюджетов, полученных результатах, даем рекомендации по доработкам сайта и согласовываем дальнейшую стратегию.
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col-sm-12 col-md-4 blo eeeeeeq">
			...
			<div class="fdfdf">
				<ul>
					...
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> 30-50 целевых посетителей в сутки по коммерческим запросам</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> 18-30 заявок в месяц при условии средней конверсии сайта 3%</li>
					...
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Ведение (при необходимости) первые <b>2 недели бесплатно</b>, потом <b>10 000 руб/месяц</b></li>
					...
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Управление ставками в зависимости от сезона/необходимости в трафике с той или иной РК</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Настройка корректировок РК, по данным Яндекс.Метрики/Google Analytics, с целью увеличение качества привлекаемой аудитории</li>
		...
		<div class="col-sm-12 col-md-4 blo eeeeeeq active">
			...
			<div class="fdfdf">
				<ul>
					...
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Настройка рекламных кампаний в Яндекс Директ</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> 50-100 целевых посетителей в сутки по коммерческим запросам</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> 30-60 заявок в месяц при условии средней конверсии сайта 3%</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Создание поисковых рекламных кампаний в Яндекс.Директ</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Создание рекламных кампаний в РСЯ</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Создание Графических рекламных кампаний в РСЯ</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Создание Ретаргетинговых рекламных кампаний в Яндекс.Директ</li>
					...
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Ведение (при необходимости) первые <b>первый месяц бесплатно</b>, потом <b>14 000 руб/месяц</b></li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Корректировка файла стоп-слов (минусация) на основе данных Яндекс.Метрики</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Переработка текстов объявлений с целью повышения CTR</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Управление ставками в зависимости от сезона/необходимости в трафике с той или иной РК</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Настройка корректировок РК, по данным Яндекс.Метрики/Google Analytics, с целью увеличение качества привлекаемой аудитории</li>
		...
		<div class="col-sm-12 col-md-4 blo eeeeeeq">
			...
			<div class="fdfdf">
				<ul>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Аудит сайта\лэндинга</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Настройка рекламных кампаний в Яндекс Директ</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> от 100 целевых посетителей в сутки по коммерческим запросам</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> 60-120 заявок в месяц при условии средней конверсии сайта 3%</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Создание поисковых рекламных кампаний в Яндекс.Директ</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Создание рекламных кампаний в РСЯ</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Создание Графических рекламных кампаний в РСЯ</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Создание Ретаргетинговых рекламных кампаний в Яндекс.Директ</li>
					...
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Ведение (при необходимости) первые <b>2 месяца бесплатно</b>, потом <b>17 000 руб/месяц</b></li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Корректировка файла стоп-слов (минусация) на основе данных Яндекс.Метрики</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Переработка текстов объявлений с целью повышения CTR</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Управление ставками в зависимости от сезона/необходимости в трафике с той или иной РК</li>
					<li><img src="../../assests/kisspng-check-mark_копия_5.png"> Настройка корректировок РК, по данным Яндекс.Метрики/Google Analytics, с целью увеличение качества привлекаемой аудитории</li>
											...
											<div class="row tm_pb_row tm_pb_row_1">
                                              <div class="tm_pb_column tm_pb_column_1_2 tm_pb_column_1 col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                                ...
                                                <form action="/mail_post.php" method="post" class="wpcf7-form">
                                                  ...
                                                  <p class="widget_text">
                                     				<input type="submit" value="Заказать" class="wpcf7-form-control tm_pb_button wpcf7-submit" onclick="ym(45994323, 'reachGoal', 'zak'); return true;"><span class="ajax-loader"></span>
                                                  </p>
...
<div class="container">
 ...
 <a class="video-popup" href="https://www.youtube.com/embed/jX8QZG4JXHY"></a> <img src="//msk.lapkinlab.ru/assests/kalinza.jpg" style="position: absolute;left: -195px;top: -65px;">
				</div>
				<div class="vr-title">
			...
			<div class="video-review">
				<div class="circle-video-block">
 <a class="video-popup" href="https://www.youtube.com/embed/XaxNwe8O6Vw"></a> <img src="//msk.lapkinlab.ru/assests/trillion.jpg" style="position: absolute;left: -195px;top: -65px;">
				</div>
				<div class="vr-title">
				...
				<div class="col-md-12 Ktabk Kactive_ta" id="Kff1">
					...
					<div class="col-md-8 cccd" style="padding:0px; margin:0px;">
						<p class="ccc">
						 ...
						 Цели достигнуты в полном объеме. Собрав семантическое ядро, мы произвели сбор ключевых фраз, затем начали прорабатывать над разбивкой рекламной кампании.
					</div>
				...
				<div class="col-md-12 Ktabk Kactive_tan" id="Kff2">
					...
					<div class="col-md-8 cccd" style="padding:0px; margin:0px;">
						<p class="ccc">
						 ...
						 Для сокращения стоимости лида мы разработали посадочные страницы под жилые комплексы, у которых частотность показов по прямым ключевым фразам составляет более 1500 в месяц. Затем под каждого застройщика были созданы отдельные рекламные кампании по прямым ключевым фразам.
					</div>
					<div style="width: 100%; height: 20px; clear: both">
					</div>
					<div class="col-md-8 imgkeq">
