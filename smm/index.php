...
<div class="container_v2">
	<div class="smm_preview_list">
		...
		<div class="smm_preview_item smm_preview_item_right">
			<p>
				 Мы проанализируем твой аккаунт, выявим недочеты и обсудим дальнейшее продвижение за 99 рублей вместо обычной цены <del>2499 руб</del>
			</p>
 ...
 <input type="tel" name="your-phone" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel" required="" aria-invalid="false" placeholder="Ваш номер телефона *">
				<p>
				</p>
				<p>
 <input type="email" name="your-email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" required="" aria-invalid="false" placeholder="Ваша электронная почта *">
				</p>
				<p style="display:none;">
 <input type="text" name="name" value="">
				</p>
				<p>
 <input type="checkbox" id="acceptance-check" name="acceptance-check" value="1" class="wpcf7-form-control wpcf7-acceptance" required="" aria-invalid="false"> <label for="acceptance-check">Я принимаю <a href="/privacy-policy" target="_blank">условия передачи информации</a> </label> <input type="submit" value="Оставить заявку на анализ аккаунта за 99 рублей" class="wpcf7-form-control wpcf7-submit"><span class="ajax-loader"> </span>
				</p>
			</form>
		</div>
	</div>
</div>
 </section> <section class="seo_header">
<div class="container_v2">
 ...
 </section> <section class="seo_content smm_content">
<div class="container_v2">
 ...
 <img alt="Продвижение в соцсетях(SMM)" src="/image/SMM.jpg">
		...
		<div class="seo_content_item_text">
			...
			<p>
				 Пока вы используете стандартные средства продвижения, мимо вашего бизнеса проходят тысячи людей, погруженных в экраны своих смартфонов. Это доказывает — продажи через интернет из прихоти давно стали необходимостью. Ваша главная задача сейчас — это найти своих клиентов в соцсетях, превратить их в постоянных покупателей, а в дальнейшем и в адвокатов вашего бренда. Для этого необходимо только выбрать нужный способ связи.
			</p>
			<p class="smm-h4">
			...
			<ul class="sBlockUL">
				<li>
				ЭКСПЕРТНОСТЬ – Мы эксперты в области SMM с многолетним опытом; </li>
				<li>
				АКТУАЛЬНОСТЬ – Мы постоянно обучаемся и развиваемся; </li>
				<li>
				НАДЕЖНОСТЬ – Мы гарантируем безопасность каждой сделки; </li>
				<li>
				ЛОЯЛЬНОСТЬ – Мы оберегаем и уважаем каждого клиента. </li>
			</ul>
			<p class="smm-h4">
				 Что такое SMM и зачем это нужно вашему бизнесу?
			</p>
			<p>
				 SMM-продвижение — это способ пообщаться со своей аудиторией напрямую, построить сильный бренд и увеличить продажи посредством социальных сетей. Социальные сети прочно вошли в жизнь миллионов людей, именно поэтому Social Media Marketing на сегодняшний день является наиболее перспективным методом продвижения.
			</p>
			<p class="smm-h5">
			...
			<ul class="sBlockUL">
				...
				<li>Вы можете оказывать ВЛИЯНИЕ на ваших подписчиков, формируя спрос на те или иные товары и услуги, создавать вирусный контент и, таким образом, охватывать ещё бОльшую аудиторию.</li>
 ...
 </section> <section class="smm_price">
<div class="container_v2">
 ...
 </section> <section class="smm_price_service">
<div class="container_v2">
	<div class="price_audit">
		<div class="price_audit_item">
			<div class="price_audit_item_top">
