                                ...
                                <div class="row tm_pb_row tm_pb_row_1">
                                    <div class="tm_pb_column tm_pb_column_1_2 tm_pb_column_1 col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <form action="/mail_post.php" method="post" class="wpcf7-form">
                                            ...
                                            <p>
                                                <span class="wpcf7-form-control-wrap your-calc"><textarea name="your-message"
                                                                                                          cols="40"
                                                                                                          rows="10"
                                    ...
                                    <div class="tm_pb_column tm_pb_column_1_2 tm_pb_column_1 col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                        <p style="font-size:22px;">Вы выбрали:</p>
                                        <table>
                                            <tbody>
                                            <tr>
                                                <td>ТИП САЙТА:</td>
                                 ...
                                 font-weight: 500;
                                 line-height: 1.1;
                                 color: inherit;" id="h4_itogo">Итого: <span id="result_itogo"></span> &#8381;/мес. <b class="tooltip"
                                                                                                                       data-tooltip="Для индивидуального расчета заполните форму.">*</b>
                                        </p>
                                    </div>
                                </div>
                            </div>
