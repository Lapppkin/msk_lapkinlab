...
$APPLICATION->SetPageProperty("title", "Раскрутка сайта в Москве: заказать продвижение сайта цены");
...
?><section class="banner active_ban" id="ban1">
          						...
          						<div class="row">
          								...
          								<div class="col-md-4">
          									<form class="form_banner">
          										...
          										<input type="text" placeholder="Сайт" value="">
          										<input type="text" placeholder="Телефон" value="">
          										<input type="text" placeholder="Почта" value="">
          										<button type="button" name="button" value="Получить рассчет">Получить рассчет</button>
          										Нажимая на кнопку Получить рассчет, я даю согласие на обработку персональных данных
          									</form>
          								</div>
          						</div>
          					</div>
              ...
              <section class="one ses">
          				<div class="container">
          						<div class="row">
          							<div class="col-md-12">
          								<h1 class="title">Комплексное продвижене сайтов</h1>
          							</div>
...
<br>
Независимо от стоимости раскрутки сайта в месяц, мы делаем все, чтобы сайт максимально соответсвовал требованиям поисковых систем и привлекал как можно больше целевых клиентов.</p>
              								</div>
              								<div class="col-sm-12 col-md-4 block_twof">
    ...
    color: inherit;">Вы выбрали:</p>
																									...
																									<tr>
																									<td>ТИП САЙТА: </td>
																									<td><span id="result_1">Корпоративный сайт</span></td>
																									</tr>
																									<tr>
    ...
    font-weight: 500;
    line-height: 1.1;
    color: inherit;" id="h4_itogo">Итого:  &#8381;/мес. <b class="tooltip" data-tooltip="Для индивидуального расчета заполните форму.">*</b></p>
																							</div>
																						</div>
																					</div>
																				</div>
				              						...
				              						<div class="row">
				              							...
				              							<div class="col-md-12">
				              								...
				              								<div class="col-sm-12 col-md-4 block_twof">
				              									...
				              									<p class="tit"> Продвижене интернет-магазинов</p>
				              						...
				              						<div class="row">
				              							...
				              							<div class="col-md-12">
				              								...
				              								<div class="col-sm-12 col-md-4 block_twof2">
																				...
																				<p>Выход в лидеры органической выдачи по широкому спектру запросов – не простая задача. Но для каждого проекта мы разрабатываем индвидуальную стратегию</p>
																				<ul>
																			...
																			<div class="row">
																					<div class="col-md-12 Ktabk Kactive_ta" id="Kff1">
																						...
																						<div class="col-md-8 cccd" style="padding:0px; margin:0px;">
																							...
																							Цели достигнуты в полном объеме. Сайт постоянно обновляется. За счет контекстной рекламы достигнута посещаемость 20 000 уникальных посетителй в месяц. Более 85% фраз в ТОП10.
																						</div>
																									<div style="width: 100%; height: 20px; clear: both"></div>
																					...
																					<div class="col-md-12 Ktabk Kactive_tan" id="Kff3">
																						...
																						<div class="col-md-8 cccd" style="padding:0px; margin:0px;">
																							<p class="ccc">Результат</p>
																							Посещаемость сайта выросла до 150 уникальныных посетителей в месяц, более 50% фраз в ТОП10.
																						</div>
																									<div style="width: 100%; height: 20px; clear: both"></div>
																						<div class="col-md-8 imgkeq">
															...
															<section class="eight">
																<div class="container">
																	<div class="row">
																		<div class="col-md-12">
																			<h3 class="title">Тарифные планы</h3>
																		</div>
																		<div class="col-md-12">
																			<div class="row">
...
<section class="tenfour">
 ...
 предлагаем клиентам эффективные стратегии.</p>
																...
																<div class="container">
																	<div class="row">
																		...
																		<div class="col-md-12 fomrbut">
																			<form>
																				<div class="col-md-4"><input type="text" placeholder="Ваше имя"></div>
																				<div class="col-md-4"><input type="text" placeholder="Телефон"></div>
																				<div class="col-md-4"><input type="text" placeholder="Почта"></div>

																				<div class="col-md-12" style="padding: 20px 15px;">
																					<textarea cols="30" rows="10" placeholder="Напишите ваш вопрос для наших специалистов"></textarea>
																				</div>
