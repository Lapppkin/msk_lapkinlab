...
<div style="padding: 10px 0; border-top: 0px solid #8E8E8E; border-bottom: 1px solid #8E8E8E; margin-bottom: 15px;"><div style="height: 30px; padding: 7px;">
        <a href="http://www.altasib.ru?utm_source=mod_feedback" target="_blank"><img src="/bitrix/images/altasib.errorsend/altasib.png" style="float: left; margin-right: 15px;" border="0" /></a>
        <div style="margin: 13px 0px 0px 0px">
                <a href="http://www.altasib.ru?utm_source=mod_feedback" target="_blank" style="color: #999; font-size: 20px; font-family: cursive; text-decoration: none"><?=GetMessage("ALTASIB_IS")?></a>
        </div>
        </div></div>
                </td>
        </tr>
