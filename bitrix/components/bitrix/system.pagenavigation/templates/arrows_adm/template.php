...
<nav class="navigation pagination" role="navigation">
	...
	if($arResult["bDescPageNumbering"] === true)
	{
		...
		?>
			<div class="nav-links">
				<span class="page-numbers"><?=GetMessage("navigation_pages")?></span>
		<?
		$bFirst = true;
		$bPoints = false;
		do
		...
		?>
				<span class="page-numbers current"><?=$NavRecordGroupPrint?></span>
		<?
				elseif($arResult["nStartPage"] == $arResult["NavPageCount"] && $arResult["bSavePage"] == false):
		?>
				<a class="page-numbers" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><?=$NavRecordGroupPrint?></a>
		<?
				else:
		?>
				<a class="page-numbers" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["nStartPage"]?>"><?=$NavRecordGroupPrint?></a>
		<?
				endif;
				$bFirst = false;
				$bPoints = true;
