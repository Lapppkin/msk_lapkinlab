/**
 * Сайт Msk.Lapkinlab.Ru
 *
 * @link https://msk.lapkinlab.ru
 * @author deadie
 */
...
var appName = 'LapkinLab (Москва)';
var appPath = 'templates/lapkinlab/';
var sourcesPath = 'templates/lapkinlab/_src/';
...
var path = {
    ...
    watch: {
        ...
        css: [
            sourcesPath + 'css/base/*.*',
            sourcesPath + 'css/common/*.*',
            sourcesPath + 'css/extra/*.*',
            sourcesPath + 'css/components/*.*',
            sourcesPath + 'css/helpers/*.*',
            sourcesPath + 'css/pages/*.*',
            sourcesPath + 'css/vendor/*.*',
            sourcesPath + 'css/*.*',
            sourcesPath + '*.pug',
        ],
        spriteSvg: sourcesPath + 'images/icons/*.svg',
        ...
        gulp.src(path.src.sprite).
            pipe(spritesmith({
                ...
                cssVarMap: function (sprite) {
                    sprite.name = 'lapicon-' + sprite.name;
                }
            }));
