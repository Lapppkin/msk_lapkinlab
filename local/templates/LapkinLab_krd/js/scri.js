$(document).ready(function() {
    ...
    $('.butt').click(function() {
        ...
        $('#ban1').removeClass('active_ban');
        $('#ban1').addClass('noactive_ban');
        $('#ban2').removeClass('active_ban');
        $('#ban2').addClass('noactive_ban');
        $('#ban3').removeClass('active_ban');
        $('#ban3').addClass('noactive_ban');
        $('#ban4').removeClass('active_ban');
        $('#ban4').addClass('noactive_ban');
    ...
    $('.bbcd').click(function() {
        ...
        $('#ibbc1').removeClass('activebi');
        $('#ibbc1').addClass('activebin');
        $('#ibbc2').removeClass('activebi');
        $('#ibbc2').addClass('activebin');
        $('#ibbc3').removeClass('activebi');
        $('#ibbc3').addClass('activebin');
        $('#ibbc4').removeClass('activebi');
        $('#ibbc4').addClass('activebin');
    ...
    $('.tabs').click(function() {
        ...
        $('#ff1').removeClass('active_ta');
        $('#ff1').addClass('active_tan');
        $('#ff2').removeClass('active_ta');
        $('#ff2').addClass('active_tan');
        $('#ff3').removeClass('active_ta');
        $('#ff3').addClass('active_tan');
        $('#ff4').removeClass('active_ta');
        $('#ff4').addClass('active_tan');
    ...
    $('.Ptabs').click(function() {
        ...
        $('#Pff1').removeClass('Pactive_ta');
        $('#Pff1').addClass('Pactive_tan');
        $('#Pff2').removeClass('Pactive_ta');
        $('#Pff2').addClass('Pactive_tan');
        $('#Pff3').removeClass('Pactive_ta');
        $('#Pff3').addClass('Pactive_tan');
        $('#Pff4').removeClass('Pactive_ta');
        $('#Pff4').addClass('Pactive_tan');
    ...
    $('.Ktabs').click(function() {
        ...
        $('#Kff1').removeClass('Kactive_ta');
        $('#Kff1').addClass('Kactive_tan');
        $('#Kff2').removeClass('Kactive_ta');
        $('#Kff2').addClass('Kactive_tan');
        $('#Kff3').removeClass('Kactive_ta');
        $('#Kff3').addClass('Kactive_tan');
