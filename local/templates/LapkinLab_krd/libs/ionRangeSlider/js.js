...
$("#result_itogo").html(sum);
      return false;
       ...
       $("A#trigger").click(function() {
        ...
        //if(r1.result.from > '0' & r2.result.from > '0' & r3.result.from > '0' & r4.result.from > '0' & r5.result.from > '0' & r6.result.from > '0' & r7.result.from > '0' & r8.result.from > '0' & r9.result.from > '0' & r10.result.from > '0' & r11.result.from > '0' & r12.result.from > '0' & r13.result.from > '0' & r14.result.from > '0'){
        if(r7.result.from > '0'){
        ...
        // if(r7.result.from == '0'){$error++; $("#range7_l").addClass("error_red");}else{ $("#range7_l").removeClass("error_red");}
        // if(r1.result.from == '0'){$error++; $("#range1_l").addClass("error_red");}else{ $("#range1_l").removeClass("error_red");}
        // if(r2.result.from == '0'){$error++; $("#range2_l").addClass("error_red");}else{ $("#range2_l").removeClass("error_red");}
        // if(r3.result.from == '0'){$error++; $("#range3_l").addClass("error_red");}else{ $("#range3_l").removeClass("error_red");}
        // if(r4.result.from == '0'){$error++; $("#range4_l").addClass("error_red");}else{ $("#range4_l").removeClass("error_red");}
        // if(r5.result.from == '0'){$error++; $("#range5_l").addClass("error_red");}else{ $("#range5_l").removeClass("error_red");}
        // if(r16.result.from == '0'){$error++; $("#range16_l").addClass("error_red");}else{ $("#range16_l").removeClass("error_red");}
        // if(r8.result.from == '0'){$error++; $("#range8_l").addClass("error_red");}else{ $("#range8_l").removeClass("error_red");}
        // if(r9.result.from == '0'){$error++; $("#range9_l").addClass("error_red");}else{ $("#range9_l").removeClass("error_red");}
        // if(r11.result.from == '0'){$error++; $("#range11_l").addClass("error_red");}else{ $("#range11_l").removeClass("error_red");}
        // if(r10.result.from == '0'){$error++; $("#range10_l").addClass("error_red");}else{ $("#range10_l").removeClass("error_red");}
        // if(r12.result.from == '0'){$error++; $("#range12_l").addClass("error_red");}else{ $("#range12_l").removeClass("error_red");}
        // if(r13.result.from == '0'){$error++; $("#range13_l").addClass("error_red");}else{ $("#range13_l").removeClass("error_red");}
        // if(r14.result.from == '0'){$error++; $("#range14_l").addClass("error_red");}else{ $("#range14_l").removeClass("error_red");}

        // if($error == '0'){
        //   $("DIV#box").fadeIn(); return false;
        // }else{
        //   alert("Заполните корректно все поля!");var scrollTop = $('#cccallk').offset().top;$(document).scrollTop(scrollTop);$("DIV#box").fadeOut(); return false;
        // }
