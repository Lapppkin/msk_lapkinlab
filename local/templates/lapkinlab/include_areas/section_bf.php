<!--сделаем так, чтобы ваш бизнес находили-->
<section class="section--bf">
    <div class="container">
        <div class="section--bf--wrapper row">
            <h2 class="section--bf--title col-12 text-center">Сделаем так, чтобы ваш бизнес находили</h2>
            <div class="section--bf--items col-12">
                <div class="row">
