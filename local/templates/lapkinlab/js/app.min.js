...
!function (e) {
  ...
  var n = {
    min: !1, init: function init() {
      $(document).on("click", 'a[href^="#top"]', (function (e) {
        var t = $(e.target).attr("href"), o = $(t);
        if (0 !== o.length) {
          e.preventDefault();
          var n = o.offset().top;
        ...
        var t = $($(e.currentTarget)[0].form), o = "";
        t.find("select.active").each((function () {
          0 !== this.selectedIndex && (o += $(this).data("label") + ": " + this.options[this.selectedIndex].text + "\r\n\r\n")
        }));
        var n = t.find('input[type="radio"]:checked'), r = {yes: "Да", no: "Нет", complicate: "Затрудняюсь ответить"};
        n.each((function () {
      ...
      o(4), $('input[name="PHONE"], input[name="phone"]').inputmask({mask: "+7(999)999-9999", placeholder: "_"})
  ...
  var n = {
    init: function init(e, t, o) {
      ...
      var r = "localStorage" in window && null !== window.localStorage, a = void 0, i = void 0, l = function l() {
  ...
  var n = o(3), r = {
    modalsContainer: "#ajax-modals-container", ajaxUrl: "/ajax/", init: function init() {
      var e = this;
      $(document).on("click", ".js-open-modal", (function (t) {
        t.preventDefault();
        var o = $(t.currentTarget).data("metrika-target"), a = $(t.currentTarget).data("modal"),
          i = e.prepareAjaxOptions();
        i.data = {action: $(t.currentTarget).data("action"), modalId: a};
        ...
        var o = $($(t.currentTarget)[0].form), a = e.prepareAjaxOptions();
        a.data = o.serialize() + "&action=sendForm", $.ajax(a).done((function (e) {
          ...
          if (void 0 === t.errors) {
            ...
            a.data = {action: "openModal", modalId: "thanks"}, $.ajax(a).done((function (e) {
      ...
      return {url: this.ajaxUrl, type: "post"}
    ...
    instance: {}, init: function init() {
      ...
      o(0), o(1), $(document).ready((function () {
        ...
        e.instance = t, 0 !== t.length && t.addClass("owl-carousel").owlCarousel({
          ...
          if(typeof image != "undefined") {$(".slider-image").attr("style", "background-image: url(" + image + ")")}
  ...
  var n = {
    ...
    options: {
      ...
      dotsEach: !0,
      autoplay: !0,
      responsive: {0: {items: 1}, 1261: {items: 3, dots: !1, loop: !1, autoplay: !1}}
    },
    init: function init() {
      var e = this;
      o(0), o(1), $(document).ready((function () {
