...
?>
<script src="<?= SITE_TEMPLATE_PATH ?>/js/new-design-home.js"></script>
</main><!--/main-->
                ...
                <div class="footer--nav-wrapper col-12">
                    <div class="footer--nav-top">
                        ...
                        <div class="footer--nav-top--contacts">
                            <div class="footer--nav-top--contacts--phone">
                                ...
                                <br>
                                <a href="#" class="js-open-modal" data-action="openModal" data-modal="callback">Заказать
                                    звонок</a>
                            </div>
                            <div class="footer--nav-top--contacts--email">
                                <?= Helper::renderEmail(SITE_CONFIG['email']) ?>
                                <br>
                                <a href="#" class="js-open-modal" data-action="openModal" data-modal="audit">Быстро
                                    отвечаем</a>
                            </div>
                            <div class="footer--nav-top--contacts--address">
                                <p>
                                    <?= renderSprite('location-white') ?><?= SITE_CONFIG['address'] ?>
                                    <br><span><?= SITE_CONFIG['metro'] ?></span>
                                </p>
                                <p class="social"><span>Мы в соцсетях:</span></p>
                                <p>
                                    <noindex>
                                    <a href="<?= SITE_CONFIG['social_telegram_bot'] ?>" rel="nofollow" target="_blank"
                                       title="Telegram Bot"><?= renderSprite('icon-circle-telegram') ?></a>
                                    </noindex>
                                    <a href="<?= SITE_CONFIG['social_instagram'] ?>" rel="nofollow" target="_blank"
                                       title="Instagram"><?= renderSprite('icon-circle-instagram') ?></a>
                                    <a href="<?= SITE_CONFIG['social_vk'] ?>" rel="nofollow" target="_blank"
                                       title="Вконтакте"><?= renderSprite('icon-circle-vk') ?></a>
                                    <a href="<?= SITE_CONFIG['social_facebook'] ?>" rel="nofollow" target="_blank"
                                       title="Facebook"><?= renderSprite('icon-circle-facebook') ?></a>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="footer--nav-bottom">
                        <div class="footer--nav-bottom--copyrights">
                            <p>© <?= Helper::autoCopyright(SITE_CONFIG['since']) ?> Все права защищены. <a href="/">LapkinLab</a>
                            </p>
                            <p><?= Helper::getPrivacyLink() ?></p>
                        </div>
                        <div class="footer--nav-bottom--partners">
                            <p>
                                <a href="/documents/Sertifikat_Biznes_Partnera_1C_Bitrix.pdf"
                                   title="Бизнес-партнер 1С-Битрикс" target="_blank">
                                    <img src="<?= SITE_TEMPLATE_PATH ?>/images/bitrix-partner.png"
                                         alt="Бизнес-партнер 1С-Битрикс"></a>
                                <a class="fancybox" data-fancybox href="<?= SITE_TEMPLATE_PATH ?>/images/amocrm.jpg"
                                   title="Партнер amoCRM">
                                    <img class="fancybox" src="<?= SITE_TEMPLATE_PATH ?>/images/amocrm-partner.jpg"
                                         alt="Партнер amoCRM"></a>
                            </p>
                        </div>
                    </div>
                </div>
...
<script>
    (function(w,d,u){
        var s=d.createElement('script');s.async=true;s.src=u+'?'+(Date.now()/60000|0);
        var h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h);
    })(window,document,'https://cdn-ru.bitrix24.ru/b13928230/crm/site_button/loader_2_p3ses0.js');
</script>
</body>
</html>
